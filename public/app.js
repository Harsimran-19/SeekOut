...
const showSuperheroDetails = (data) => {
    ...
    <li>
        <div>
            ...
            <span class="px-4 mx-6">intelligence</span>
        </div>
    ...
    <li>
        <div>
            <i class = "fa-solid fa-shield-halved"></i>
            <span class="px-4 mx-6">strength</span>
        </div>
    ...
    <li>
        <div>
            <i class = "fa-solid fa-shield-halved"></i>
            <span class="px-4 mx-6">speed</span>
        </div>
    ...
    <li>
        <div>
            <i class = "fa-solid fa-shield-halved"></i>
            <span class="px-4 mx-6">durability</span>
        </div>
    ...
    <li>
        <div>
            <i class = "fa-solid fa-shield-halved"></i>
            <span class="px-4 mx-6">power</span>
        </div>
    ...
    <li>
        <div>
            <i class = "fa-solid fa-shield-halved"></i>
            <span class="px-4 mx-6">combat</span>
        </div>
    ...
    <li>
        <span class="text-3xl font-bold">full name</span>
        <span class="text-3xl font-light">${data[0].biography['full-name']}</span>
    </li>
    <li>
        <span class="text-3xl font-bold">alert-egos</span>
        <span class="text-3xl font-light">${data[0].biography['alter-egos']}</span>
    </li>
    <li>
        <span class="text-3xl font-bold">aliases</span>
        <span class="text-3xl font-light">${data[0].biography['aliases']}</span>
    </li>
    <li>
        <span class="text-3xl font-bold">place-of-birth</span>
        <span class="text-3xl font-light">${data[0].biography['place-of-birth']}</span>
    </li>
    <li>
        <span class="text-3xl font-bold">first-apperance</span>
        <span class="text-3xl font-light">${data[0].biography['first-appearance']}</span>
    </li>
    <li>
        <span class="text-3xl font-bold">publisher</span>
        <span class="text-3xl font-light">${data[0].biography['publisher']}</span>
    </li>
    `;
